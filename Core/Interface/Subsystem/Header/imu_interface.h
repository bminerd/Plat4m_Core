...
/**
 * @brief Enumeration of IMU accelerometer degrees of freedom.
 */
...
/**
 * @brief Enumeration of IMU gyroscope degrees of freedom.
 */
...
/**
 * @brief Enumeration of IMU magnetometer degrees of freedom.
 */
...
/**
 * @brief Enumeration of IMU errors.
 */
typedef enum _imu_error_e_
{
    IMU_ERROR_NONE,
    IMU_ERROR_PARAMETER_INVALID,
    IMU_ERROR_NOT_ENABLED,
    IMU_ERROR_COMMUNICATION
} imu_error_e;
