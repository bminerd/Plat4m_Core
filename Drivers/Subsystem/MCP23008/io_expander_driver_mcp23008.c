...
/**
 * @file io_expander_driver_mcp23008.c
 * @author Ben Minerd
 * @date 10/11/2012
...
#include <io_expander_driver_mcp23008.h>
 ...
 * @return I2C error.
 */
static i2c_error_e regWrite(io_expander_mcp23008_t* expander,
                            const io_expander_mcp23008_reg_e reg,
                            const uint8_t value);
 ...
 * @return I2C error.
 */
static i2c_error_e regWriteBit(io_expander_mcp23008_t* expander,
                               const io_expander_mcp23008_reg_e reg,
                               const uint8_t bit,
 ...
 * @return I2C error.
 */
static i2c_error_e regRead(io_expander_mcp23008_t* expander,
                           const io_expander_mcp23008_reg_e reg,
                           uint8_t* value);
 ...
 * @return I2C error.
 */
static i2c_error_e regReadBit(io_expander_mcp23008_t* expander,
                              const io_expander_mcp23008_reg_e reg,
                              const uint8_t bit,
                              bit_value_e* value);
                                      ...
                                      const bool enabled)
{
    ...
    io_expander_mcp23008_t* thisExpander = (io_expander_mcp23008_t*) expander;

    io_expander_mcp23008_info_t* info =
        (io_expander_mcp23008_info_t*) thisExpander->private;
    ...
    if (enabled)
    {
        ...
        info->regValueMap[IO_EXPANDER_MCP23008_REG_IODIR] = 0xFF;
        info->regValueMap[IO_EXPANDER_MCP23008_REG_IODIR] = 0xFF;
    }
    else
    {
                                ...
                                const io_expander_io_hardware_config_t* config)
{
    ...
    regWriteBit(thisExpander,
                IO_EXPANDER_MCP23008_REG_IODIR,
                hardware->pin,
...
{
    io_expander_mcp23008_info_t* info =
        (io_expander_mcp23008_info_t*) expander->private;
