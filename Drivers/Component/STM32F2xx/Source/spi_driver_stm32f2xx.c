 ...
 */
static spi_interface_int_handler_f* intHandler;
 ...
 */
static const spi_gpio_t gpioMap[SPI_COUNT][SPI_GPIO_MAP_COUNT] =
{
    /// SPI_1
    {
        /// SPI_GPIO_MAP_1
...
void spiDriverStm32f2xxInit(void)
{
    ...
    spiSetDriver(&driver, &intHandler);
}
